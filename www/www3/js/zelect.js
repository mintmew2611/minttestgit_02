...
(function($) {
  ...
  $.fn.zelect = function(opts) {
    ...
    return this.each(function() {
      ...
      var $zelect = $('<div>').addClass('zelect hover open')
      ...
      var $search3 = $('<i>').addClass('icon ion-search placeholder-icon')
      var $search2 = $('<label>').addClass('item item-input').append($search).append($search3)
      ...
      $zelect.insertAfter($select)
        .append($selected)
        .append($dropdown.append($('<div>').addClass('zearch-container').append($search2).append($noResults)).append($list))
