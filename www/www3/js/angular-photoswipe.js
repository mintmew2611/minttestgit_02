...
ngPhotoSwipe.directive('photoSlider', [ function () {
	var template = 
		...
		'<button class="pswp__button delete_imgzoom" ng-disabled="premiss_write_ass9"  style="margin-top: 12px;background-color: transparent;height: 50px; width: 50px;background-image: url(img/icon_bin.png);background-repeat: no-repeat;background-size: 25px 20px;z-index: 99999999999;right: 30px;opacity:1;"></button>' +
			...
			'<div class="pswp__scroll-wrap">' +
				...
				'<div class="pswp__ui pswp__ui--hidden">' +
					'<div class="pswp__top-bar pswp--zoom-allowed">' +
...
ngPhotoSwipe.directive('photoGallery', [ function () {
	var template = 
		'<figure itemprop="associatedMedia" class="img{{$index}}" itemscope itemtype="http://schema.org/ImageObject" ng-repeat="img in images track by $index" >' +
